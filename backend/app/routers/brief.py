...
def _call_anthropic(
    ...
    prompt = (
        ...
        "confidence-scored cells). Each engagement is an independent market model; "
        "there is no canonical or reference vertical.\n\n"
        f"Families in the currently-active engagement (context only, NOT a default): {families_json}\n"
        ...
        "active engagement's existing families.\n"
        "- In interpretation_notes and taxonomy_status.note, describe the NEW market on its own "
        "terms. Do NOT name, compare to, or reference the active engagement's industry (e.g. do not "
        "say 'unlike the medtech taxonomy'); the user is starting a fresh, independent engagement.\n"
